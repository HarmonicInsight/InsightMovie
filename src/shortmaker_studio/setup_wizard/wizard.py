...
class WelcomePage(QWizardPage):
    ...
    def __init__(self):
        super().__init__()
        self.setTitle("ShortMaker Studio へようこそ")
        ...
        # 説明テキスト
        intro = QLabel(
            "このウィザードでは、ShortMaker Studioを使用するための\n"
            "初期設定を行います。\n\n"
            "設定内容：\n"
            "・VOICEVOXエンジンの検出と起動\n"
            "・デフォルト話者の設定\n"
...
class CompletionPage(QWizardPage):
    ...
    def __init__(self):
        ...
        completion_text = QLabel(
            "✓ セットアップが完了しました！\n\n"
            "「完了」をクリックしてShortMaker Studioを開始してください。\n\n"
            "今すぐ音声生成を試すことができます。"
        )
...
class SetupWizard(QWizard):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("ShortMaker Studio - 初回セットアップ")

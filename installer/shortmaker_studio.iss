; Inno Setup Script for ShortMaker Studio
; Windows インストーラー設定

#define MyAppName "ShortMaker Studio"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "ShortMaker"
#define MyAppURL "https://github.com/yourusername/shortmaker-studio"
#define MyAppExeName "ShortMakerStudio.exe"
...
OutputBaseFilename=ShortMakerStudio-Setup-{#MyAppVersion}
Compression=lzma
...
Source: "..\build\dist\ShortMakerStudio\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Filename: "{cmd}"; Parameters: "/c python ""{tmp}\voicevox_downloader.py"" --install-dir ""{localappdata}\ShortMakerStudio\voicevox"""; StatusMsg: "VOICEVOXエンジンをダウンロード中..."; Flags: runhidden waituntilterminated; Tasks: voicevoxsetup; Check: PythonInstalled
...
Filename: "{cmd}"; Parameters: "/c rd /s /q ""{localappdata}\ShortMakerStudio\voicevox"""; Flags: runhidden; Check: VoicevoxInstalled
...
var
  VoicevoxPath: String;
begin
  VoicevoxPath := ExpandConstant('{localappdata}\ShortMakerStudio\voicevox');
